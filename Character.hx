	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'sonic':
				...
				animation.addByPrefix('singDOWN-alt', 'Sing Down', 24);
			...
			case 'sonicLordX':
				...
				playAnim('idle');
			case 'sunky':
				//there are unused parts of ron, like his ugh animations are unused...
			...
			case 'little-man':
					tex = Paths.getSparrowAtlas('characters/Dumbass_Shit');
					frames = tex;
					animation.addByPrefix('idle', "idle", 24);
					animation.addByPrefix('singUP', 'up', 24, false);
					animation.addByPrefix('singDOWN', 'down', 24, false);
